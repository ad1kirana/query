...
where 
hbrv_cabang between '$brfrom' and '$brto'
and paysalesoffice between '$sfrom' and '$sto'
and hbrv_tgl  between '$dfrom' and '$dto'
and type_jurnal <> 'tp'
...
where
hs_cabang between '$brfrom' and '$brto'
and paysalesoffice between '$sfrom' and '$sto'
and paydate between '$dfrom' and '$dto'   
and paytipe='cash'
