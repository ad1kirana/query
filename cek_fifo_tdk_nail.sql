select stok_cabang,stok_tanggal as tgl,stok_kode_transaksi,stok_warehouse,stok_no_doc,stok_kode_product,stok_kode_barang,stok_qty,a.qty as qty_fifo,
...
and t.mc_kode_barang='SHE-SPR ATF MD3(1L)'

and t.MC_Tanggal between '2018/01/01' and  '2018/06/04'
...
where stok_kode_barang='SHE-SPR ATF MD3(1L)' and
 stok_cabang='03' 

and stok_kode_transaksi not like 't%'
and STOK_Tanggal between '2018/01/01' and  '2018/06/04'
